#!/bin/bash
#SBATCH --job-name=score_radio_g001_4    # job name
...
#SBATCH --output=score_radio_g001_4%j.out   # output file name
#SBATCH --error=score_radio_g001_4%j.out    # error file name
