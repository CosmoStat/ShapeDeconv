...
def get_batch_from_fits(filename, idx_list=np.arange(10000), noise_std=None, SNR=None,
                        ...
                        risktype="GCV",reg="Dirac",reg_frac=1.0,tol=1e-12,shape_constraint=False,win_filename=
    ...
    if shape_constraint:
        ...
        output=([batch_nowin[0], win_list,norm_list], batch_nowin[1])
        return output
    ...
    while True:
        ...
        for cbatch in range(0,  nb_img_per_file, batch_size):
            ...
            data_bundle = get_batch_from_fits(filename, noiseless_img_hdu=noiseless_img_hdu,
                                               ...
                                               rho_fista=rho_fista,risktype=risktype,reg=reg,
                                               reg_frac=reg_frac,tol=tol,shape_constraint=shape_constraint,
                                               win_filename=winname,
                                               win_hdu=win_hdu, mom_hdu=mom_hdu)
